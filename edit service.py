...
class HeyStack_ATS(unittest.TestCase):
    ...
    def test_site(self):
        ...
        driver.find_element_by_id("id_service_category").send_keys("edit service")
        time.sleep(3)
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("edit description")
        time.sleep(3)
