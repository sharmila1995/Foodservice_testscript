...
class HeyStack_ATS(unittest.TestCase):
    ...
    def test_site(self):
        ...
        time.sleep(3)
        driver.find_element_by_id("id_service_category").send_keys("test service")
        time.sleep(3)
        driver.find_element_by_id("id_description").send_keys("test description")
        time.sleep(3)
        driver.find_element_by_id("id_location").send_keys("test location")
        time.sleep(3)
        driver.find_element_by_id("id_service_charge").send_keys("15")
        time.sleep(3)
